...
@Component({
    ...
    template: `                
                ...
                <button style="background: none; border:none;" [colorPicker]="getCellTextColor()"  [cpOutputFormat]="hex" (colorPickerChange)="changeSelectedCellsTextColor($event)"><button md-icon-button><md-icon [style.color]="getCellTextColor()">format_color_text</md-icon></button></button>
                ...
                <button md-icon-button (click)="clearSelection()"><md-icon>clear</md-icon></button>
                <button md-button *ngIf="element.selectionWidth > 1 || element.selectionHeight > 1" (click)="mergeCells()">Merge</button>
                <button md-icon-button (click)="changeSelectedCellsBorderStyle('none')"><md-icon></md-icon>border_clear</button>
                <button md-icon-button (click)="changeSelectedCellsBorderStyle('solid none')">Top and bottom</button>
                <button md-icon-button (click)="changeSelectedCellsBorderStyle('none solid')">Left and right</button>
                <button md-icon-button (click)="changeSelectedCellsBorderStyle('solid')">All sides</button>
